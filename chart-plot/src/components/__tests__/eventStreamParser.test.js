const parser = require("../events/eventStreamParser");

it("should identify a start event", () => {
  const event = {
    type: "start",
    timestamp: 1617829200000,
...
it("should identify a stop event", () => {
  const event = { type: "stop", timestamp: 1617829200000 };
...
it("should identify a data event", () => {
  const event = { type: "data", timestamp: 1617829200000 };
...
const inicialData = `{type: 'start', timestamp: 1617829200000, select: ['min_response_time', 'max_response_time'], group: ['os', 'browser']}
{type: 'span', timestamp: 1617829200000, begin: 1617829200000, end: 1617829230000}
{type: 'data', timestamp: 1617829210000, , os: 'linux', browser: 'chrome', min_response_time: 0.1, max_response_time: 1.5}
{type: 'data', timestamp: 1617829220000, , os: 'windows', browser: 'firefox', min_response_time: 0.0, max_response_time: 2.3}
{type: 'stop', timestamp: 1617829230000, }`;
