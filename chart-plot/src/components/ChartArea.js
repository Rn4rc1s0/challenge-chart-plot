...
import { parseEventStreamToList } from "./events/eventStreamParser";
import { reduceEventsInDataChart } from "./events/eventListReducer";
...
export default class ChartArea extends React.Component {
  ...
  render() {
    return (
      <div
        className="ChartArea"
        style={{ position: "relative", height: "50vh", width: "65vw" }}
      >
